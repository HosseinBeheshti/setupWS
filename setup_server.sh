...
echo -e "   - Access VNC via: https://vnc-<username>.${CLOUDFLARE_DOMAIN:-autoazma.ir}"
echo -e "   - Access SSH via: cloudflared access ssh --hostname ssh.${CLOUDFLARE_DOMAIN:-autoazma.ir}"
echo ""

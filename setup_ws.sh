...
echo -e "  ${GREEN}Clients:${NC}      ${WG_CLIENT_COUNT} configuration(s) generated"
echo -e "  ${GREEN}Config Dir:${NC}   /etc/wireguard/clients/"
echo -e "-----------------------------------------------------"
echo ""
...
echo -e ""
echo -e "2. ${BLUE}Distribute WireGuard configs:${NC}"
echo -e "   - Desktop: ${CYAN}scp root@$VPS_PUBLIC_IP:/etc/wireguard/clients/client1.conf .${NC}"
echo -e "   - Mobile: ${CYAN}cat /etc/wireguard/clients/client1_qr.txt${NC}"
echo -e ""

...
# ============================================================
print_header "Step 1/7: Installing All Required Packages"
...
# ============================================================
print_header "Step 5/7: Running Configuration Scripts"
...
echo -e "   Check status: ${CYAN}sudo systemctl status xray${NC}"
